package br.com.meuconcurso.notifications
...
import br.com.meuconcurso.MainActivity
import br.com.meuconcurso.MeuConcursoApplication
import br.com.meuconcurso.R
...
class DailyStudyReminderWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params) {
    override suspend fun doWork(): Result {
        val app = applicationContext as MeuConcursoApplication
        ...
        val body = when {
            ...
            else -> "Abra o Meu Concurso e avance um tópico hoje. Consistência vale mais que uma sessão perfeita."
        }
