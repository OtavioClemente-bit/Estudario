...
class StudyPlanCodec {
    fun decode(text: String): StudyPlanFileV1 {
        ...
        if (root.optString("format") != FORMAT) throw StudyPlanValidationException("Formato inválido. Esperado: $FORMAT.")
    ...
    companion object { const val FORMAT = "meu-concurso-plano"; const val VERSION = 1 }
}
