...
@Entity(
    ...
    foreignKeys = [
        ...
        ForeignKey(entity = br.com.estudario.data.local.SubjectEntity::class, parentColumns = ["id"], childColumns = ["subjectId"], onDelete = ForeignKey.CASCADE),
    ],
...
@Entity(
    ...
    foreignKeys = [
        ForeignKey(entity = AnnualPhaseEntity::class, parentColumns = ["id"], childColumns = ["phaseId"], onDelete = ForeignKey.CASCADE),
        ForeignKey(entity = br.com.estudario.data.local.TopicEntity::class, parentColumns = ["id"], childColumns = ["topicId"], onDelete = ForeignKey.CASCADE),
    ],
